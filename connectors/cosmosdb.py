...
class CosmosDBClient:
    ...
    def __init__(self):
        ...
        self.db_id = config.get_value("AZURE_DB_ID")
        self.db_name = config.get_value("AZURE_DB_NAME")
...
# self.history = self.conversation_data.get('history', [])
    ...
    async def list_documents(self, container_name) -> list:
        ...
        """
        async with CosmosClient(self.db_uri, credential=config.aiocredential) as db_client:
